...
// edit console.log to change what you want to receive as a response in your terminal
const server = http.createServer((req, res) => {
    console.log(req.url, req.method, req.headers);

    // technically you can send response back from the server this way, this is here for learning purposes, not usually done this way in real webs

    // parse url as constant
    const url = req.url;
